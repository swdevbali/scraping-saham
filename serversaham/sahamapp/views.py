...
def get_chart(requests, perusahaan, durasi):
    """
    Fungsi ini akan menghasilkan image dari data stock setahun terakhir dari perusahaan tertentu
    :return:
    """
    import requests
    import json
    ...
    try:
        ...
        return HttpResponse('<h1>{}</h1><br>Harap periksa kembali kode perusahaan yang diminta.'.format(ex))
